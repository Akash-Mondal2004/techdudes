                    ...
                    <div className="hidden lg:flex lg:flex-row lg:items-center" id="desktop-menu">
                        ...
                        {!localStorage.getItem("authToken") ? (
                            <div className="flex items-center ml-4">
                                <Link
                                    to="/loginuser"
                                    className="login text-black bg-white-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none"
                                >
                                    Log in
                                </Link>
                                <Link
                                    to="/createuser"
                                    className="abc text-white bg-blue-700 hover:bg-red-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 ml-2 focus:outline-none"
                                >
                                    Sign up
                                </Link>
                            </div>
